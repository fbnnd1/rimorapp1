...
function atualiza_tela() {
    ...
    if (str_r != "") {
        ...
        $("#div_msg_ult_jogadores_msg").html(str_html_msg + "<br />" + str_msg);
...
function obtem_jogadores () {
    ...
    if ((var_r != false) && (var_r != null)){
        ...
        for (obj_jogador_temp of var_r) {
            ...
            str_dados_temp = str_dados_temp.replace("@@posicao@@", int_contador);
            ...
            if (obj_jogador_temp.nome == obj_jogador.nome) { //É o Jogador
                ...
                str_dados_temp = str_dados_temp.replace("dados_ranking", "destaque-ranking");

                //O Jogador caiu de posição
                if ((int_contador < obj_jogador.posicao) && (obj_jogador.posicao != 0)) { //A ordem atual do jogador é menor que a anterior
                    var int_q = obj_jogador.posicao - 1;
                    //alert(int_q);
                    //alert(var_r[int_q].nome);
                ...
                obj_jogador.posicao = int_contador;
...
function at_pontuacao_jogador_painel1() {
    ...
    //$("#div_lugares").html(ponteiro_arr_xy + 1); 
...
$(document).ready(function () {
    ...
    $("#btn-palpitar").click(function () {
        ...
        var arr_latlon1 = [obj_lugar_temp.latitude, obj_lugar_temp.longitude];

        //var flt_d = obtem_distancia(arr_pub_xy[ponteiro_arr_xy], ol.proj.fromLonLat(arr_latlon1));
        var flt_d = obtem_distancia( ol.proj.toLonLat(arr_pub_xy[ponteiro_arr_xy]),arr_latlon1);
        ...
        if (flt_d <= 11.00) {
            ...
            $("#div-info-lugar").html("<b>Lugar<b><br />" + obj_lugar_temp.descricao);
    ...
    $("#btn-f1").click(function () {
        ...
        var arr1 = [obj_lugar_temp.latitude, obj_lugar_temp.longitude];
        var arr2 = [obj_mapa_jogo.pontos[0].latitude, obj_mapa_jogo.pontos[0].longitude];
        var flt_d = obtem_distancia(arr1,arr2);
        flt_d = flt_d / 1000;
        //var str_a1 = $("#div-texto-magia").html() + "<br />";
        $("#div-texto-magia").html(flt_d.toString().replace(".", ",")  + " Km de distância do início.");
...
/*
$("#msg_usuario").html(obj_lugar_temp.descricao);
$("#modal_msg").modal({backdrop: "static"});
*/